// const cars = ["Honda", "Toyota", "Subaru"]
// let lastcars=cars.pop()
// cars.pop();
// console.log(cars);
...
// console.log([1],[2]);const arr = ["t", "e", "s", "t"];
...
addPerson('Cyril Sneer', '999 Dorella Street', 'Canterbury', 'Lynch Holdings\, Inc.');
...
addCompany('Logobrand', 'Marketing', 1998, 2004);
