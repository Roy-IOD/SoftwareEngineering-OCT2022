    ...
    render() {
        return (
            <div className="ClockDisplay componentBox">
                ...
                <button id="button" onClick={this.toggleClock}>{this.state.showClock ? "Hide":"Show"}</button>
                 {/* update this button to use the new toggleClock function and say 'Hide' or 'Show' depending */}
            </div>
        )
    }
}
