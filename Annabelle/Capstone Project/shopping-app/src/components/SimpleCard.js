...
function BasicExample() {
  return (
    <Grid container spacing={2} style={{display:'flex', flexDirection:'row', justifyContent:'center', fontFamily:'Montserrat',textAlign:'center', backgroundColor:'#fffae6'}}>
        ...
        <Card href="/Eyes" sx={{ maxWidth: 345 }}>
      <CardActionArea>
        <CardMedia
          component="img"
          height="200"
      ...
      <Grid item style={{width:'300px'}}>
        <Card href="/Lips" sx={{ maxWidth: 345 }}>
      <CardActionArea>
        <CardMedia
          component="img"
          height="200"
      ...
      <Grid item style={{width:'300px'}}>
        <Card href="/Skin" sx={{ maxWidth: 345 }}>
      <CardActionArea>
        <CardMedia
          component="img"
          height="200"
      ...
      <CardActionArea>
        ...
        />
        <CardContent>
          <Typography href="/Eyebrows" variant="h5" component="div" style={{fontFamily:'Montserrat'}}>
            EYEBROWS
          </Typography>
        </CardContent>
      </CardActionArea>
