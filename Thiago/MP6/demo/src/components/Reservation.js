...
class Reservation extends React.Component {
    ...
    handleSubmit = (e) => {
        ...
        alert(`${this.state.name} is ${this.state.isGoing ? '' : 'not '}attending with ${this.state.numberOfGuests} guests, ${this.state.theDate}`)
    }
    ...
    render() {
        return (
            <form onSubmit={this.handleSubmit} className="Reservation componentBox">
                ...
                <label>
                    Date:
                    <input name="date" type="number" value={this.state.theDate} onChange={this.handleInputChange} />
                </label>
