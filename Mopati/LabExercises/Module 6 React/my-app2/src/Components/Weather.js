  ...
  render() {
    return (
      <div className="Weather componentBox">
        <div>
          Weather Today: {this.state.weather}. Temp is {this.state.temperature}
          &deg;C
        </div>
        ...
        <button onClick={() => this.windStopsBlowing()}>
          Wind Stops Blowing
        </button>
...
function Forecast(props) {
  return <div className="Forecast">Weather Tomorrow: {props.weather}</div>;
}
